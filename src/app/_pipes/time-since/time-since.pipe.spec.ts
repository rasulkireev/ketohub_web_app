...
describe('TimeSincePipe', () => {
  ...
  it('should use minutes for values less than 60 minutes', () => {
    jasmine.clock().mockDate(new Date('2010-01-01T00:00:00+00:00'));
  ...
  it('should use months for values less than 12 months', () => {
    jasmine.clock().mockDate(new Date('2010-01-01T00:00:00+00:00'));
